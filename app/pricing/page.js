...
export const metadata = {
  title: 'Pricing',
  description: 'Transparent, pay-as-you-go pricing for virtual OTP numbers, number rentals, and travel eSIM data. OTP numbers are charged only when the code arrives.',
...
const notes = [
  [Check, 'OTP numbers are charged only when a verification code is delivered — no code, no charge.'],
  ...
  return (
    <>
      ...
      <main id="main" className="mx-auto max-w-4xl px-5 pt-14 pb-20">
        ...
        <h1 className="mt-5 text-3xl sm:text-4xl font-semibold tracking-tight text-white">Transparent, pay-as-you-go pricing</h1>
        <p className="mt-4 text-lg text-mut leading-relaxed">
          You only pay for what you use. Live prices vary by service, country and availability, and the exact price is always shown before you buy. The examples below are indicative.
        </p>
